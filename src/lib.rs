...
mod tests {
    ...
    fn encode_and_decode() {
        ...
        //PROBLEM
        let x = vec![ 0xdd, 0x5c, 0x01, 0x20, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x03, 0x41, 0x53, 0x44,
        0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x29, 0x04, 0xd0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0c,
        0x00, 0x0a, 0x00, 0x08, 0x74, 0x4f, 0xec, 0x27, 0x64, 0x9c, 0x14, 0xfa ];

        //PROBLEM RESPONSE
        /*
        0000   dd 5c 81 05 00 01 00 00 00 00 00 01 03 41 53 44
        0010   00 00 01 00 01 00 00 29 02 00 00 00 00 00 00 06
        0020   00 0f 00 02 00 14
        */
